...
referentials <- list(vessel_length = read_xlsx(path = path_referentials,
                                               sheet = "VESSEL_LENGTH",
                                               range = "a13:b19",
                     ...
                     metier = read_xlsx(path = path_referentials,
                                        sheet = "METIER",
                                        range = "a2:a1133",
                                        col_names = "metier_code"),
                     supra_region = read_xlsx(path = path_referentials,
                                        sheet = "SUPRA_REGION",
                                        range = "a2:b4",
                                        col_names = c("supra_region",
                                                      "supra_region_name")),
                     sub_region_eez_indicator = read_xlsx(path = path_referentials,
                     ...
                     geo_indicator = read_xlsx(path = path_referentials,
                                               ...
                                               col_names = c("geo_indicator",
                                                             "geo_indicator_name")),
                     nep_sub_region = read_xlsx(path = path_referentials,
                                                sheet = "NEP_SUB_REGION",
                                                range = "a2:d47",
                                                col_names = c("nep_sub_region",
                                                              "sub_region",
                                                              "fu",
                     ...
                     specon_tech = read_xlsx(path = path_referentials,
                                                ...
                                                col_names = c("specon_tech",
                                                              "specon_tech_name")),
                     rectangle_type = read_xlsx(path = path_referentials,
                                                sheet = "RECTANGLE_TYPE",
                                                range = "a2:b5",
                                                col_names = c("rectangle_type",
                                                              "rectangle_type_name")))

rm(path_referentials)
...
balbaya_landing <- balbaya_landing %>%
  mutate(vessel_length = case_when(vessel_length < 10 ~ "VL0010",
         ...
         fishing_mode = case_when(fishing_mode == 1 ~ "FOB",
                                  ...
                                  TRUE ~ "error"),
         supra_region = "OFR",
         domain_landings_bis = paste(country,
                                     quarter,
                                     sub_region,
                                     paste(gear_type,
                                           fishing_mode,
...
balbaya_landing_cwp$cwp <- paste0("6",
                                  balbaya_landing_cwp$cwp)
